...
- [ ] **M3** — conversation memory ([threads + checkpointer done](docs/short-term-memory.md)) + [human-in-the-loop for risky patterns done](docs/human-in-the-loop.md) + [long-term memory across conversations done](docs/long-term-memory.md)
