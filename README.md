...
**Stack:** Python · LangGraph · LangSmith · any LangChain chat model (Claude by default, swappable per run with `--model` or in `.env` via `S2P_MODEL`) · TypeScript toolchain as the referee
